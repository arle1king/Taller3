...
public class GeneradorTiquetes
{
    ...
    public static Tiquete generarTiquete(Vuelo vuelo, Cliente cliente, int tarifa) {
        ...
        do {
            ...
            int numero = (int) (Math.random() * 1_000_0000); // Asegura que el número esté en el rango 0-9999999
            codigo = String.format("%07d", numero); // Asegura que el código tenga siempre 7 dígitos
        } while (codigos.contains(codigo));

        // Crea el nuevo tiquete con el código único
        Tiquete tiquete = new Tiquete(codigo, vuelo, cliente, tarifa);
        
        // Registra el tiquete generado
